...
-  This set of scenarios data would use fff (fossil fuel funding) as its core social driver (similar to the way the SSPs use "population"). FFF would include the two subcatagories: fffinvestment and fffsubsidies. This is a fixed catagory, and would only include these two factors.
-   A mediating metric would be L (Localization) which aims to measure the degree to which processes and power-structures have been localized in ways that have been found to corelate with emissions reductions. This is an expanding catagory, and might be modified to include new factors that are established as these datasets expand. 
